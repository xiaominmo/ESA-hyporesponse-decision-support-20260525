...
def _phenotype_rules(ctx: Dict[str, Any], phenotype: str) -> List[Dict[str, Any]]:
    ...
    if idx == 0:  # Long-Vintage Mineral-Metabolic Phenotype
        title = "Phenotype focus: Long-Vintage Mineral-Metabolic Phenotype"
        rationale = (f"Assigned phenotype is Long-Vintage Mineral-Metabolic Phenotype; "
    ...
    else:  # Advanced-Age Inflammatory-Nutritional Phenotype
        title = "Phenotype focus: Advanced-Age Inflammatory-Nutritional Phenotype"
        rationale = (f"Assigned phenotype is Advanced-Age Inflammatory-Nutritional Phenotype; "
